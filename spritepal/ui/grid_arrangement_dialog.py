...
from PyQt6.QtGui import QImage, QPixmap, QPainter, QColor, QPen, QBrush, QKeyEvent, QWheelEvent
    ...
    def _zoom_at_point(self, point, zoom_factor):
        ...
        if new_zoom != self.zoom_level:
            ...
            if hasattr(point, 'toPoint'):
                point_as_qpoint = point.toPoint()
            else:
                point_as_qpoint = point
    ...
    def _export_arrangement(self):
        ...
        try:
            ...
            if arranged_image:
                ...
                arrangement_data = self.preview_generator.create_arrangement_preview_data(
