...
from PyQt6.QtCore import QObject, QThread, QTimer, QMutex, QMutexLocker, pyqtSignal
...
class PooledPreviewWorker(SpritePreviewWorker):
    ...
    def setup_request(self, request, extractor) -> None:
...
class PreviewWorkerPool(QObject):
    ...
    def submit_request(self, request, extractor) -> None:
        """
