...
from .grid_arrangement_manager import TilePosition, TileGroup
...
class GridImageProcessor(RowImageProcessor):
    ...
    def create_column_strip(self, col_index: int) -> Optional[Image.Image]:
        ...
        for i, (position, tile_img) in enumerate(column_tiles):
    ...
    def create_row_strip(self, row_index: int) -> Optional[Image.Image]:
        ...
        for i, (position, tile_img) in enumerate(row_tiles):
            x = i * self.tile_width
