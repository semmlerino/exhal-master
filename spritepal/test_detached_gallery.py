...
class TestMainWindow(QMainWindow):
    ...
    def test_detached_window(self):
        ...
        central = self.detached_window.centralWidget()
        ...
        if gallery.container_widget:
            ...
            if actual_height > expected_height + 100:
                ...
                print(f"  ✅ NO STRETCHING - Gallery fits content!")
    ...
    def test_maximized(self):
        ...
        if gallery.container_widget:
            ...
            if actual_height > expected_height + 100:
                ...
                print(f"  ✅ SUCCESS! Gallery doesn't stretch in detached window")
                print(f"  The detached window solution WORKS!")
