...
class TestSetupLogging:
    ...
    def test_setup_logging_formatters(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "%(levelname)s - %(name)s - %(message)s" == console_format
    ...
    def test_setup_logging_creates_directory_recursively(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            logger = setup_logging(log_dir=nested_log_dir)
    ...
    def test_setup_logging_writes_startup_message(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(log_file, 'r') as f:
                content = f.read()
                assert "SpritePal logging initialized" in content
...
class TestGetLogger:
    ...
    def test_get_logger_different_modules(self):
        ...
        test_modules = ["extractor", "palette_manager", "ui.main_window", "core.injector"]
