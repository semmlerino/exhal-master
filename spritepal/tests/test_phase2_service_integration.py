...
from utils.file_validator import FileValidator, ValidationResult, FileInfo
...
from utils.constants import (
    VRAM_MIN_SIZE, VRAM_MAX_SIZE, CGRAM_EXPECTED_SIZE, OAM_EXPECTED_SIZE,
    BYTES_PER_TILE, COLORS_PER_PALETTE, VRAM_PATTERNS, CGRAM_PATTERNS
)

# Core dependencies
from core.managers.exceptions import ValidationError, FileOperationError
from tests.utils.file_helpers import create_temp_directory, create_test_files
from tests.utils.data_generators import generate_cgram_data, generate_oam_data
