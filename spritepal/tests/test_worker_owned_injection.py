...
class TestWorkerOwnedInjectionPattern:
    ...
    def test_worker_owned_vram_injection_no_global_state(self, qtbot, test_sprite_files, test_vram_files):
        ...
        try:
            ...
            print(f"✅ Worker-owned injection pattern test PASSED:")
            print(f"   - Manager created with proper Qt parent: {worker.manager.parent() is worker}")
            print(f"   - No Qt lifecycle errors detected")
            print(f"   - Manager responsive (progress signals: {len(progress_spy)})")
            print(f"   - Worker isolation proven (no global registry needed)")
            ...
            if "wrapped C/C++ object" in str(e):
                ...
                print(f"✅ Worker-owned injection pattern test PASSED (no Qt lifecycle errors)")
    ...
    def test_multiple_concurrent_injection_workers_isolated(self, qtbot, test_sprite_files, test_vram_files):
        ...
        print(f"✅ Concurrent injection workers test PASSED:")
        print(f"   - Both workers created with isolated managers")
        print(f"   - No Qt lifecycle errors detected")
        print(f"   - Worker isolation proven (independent operation)")
    ...
    def test_custom_injection_manager_factory(self, qtbot, test_sprite_files, test_vram_files):
        ...
        print(f"✅ Custom factory injection test PASSED - no Qt lifecycle errors")
    ...
    def test_worker_owned_rom_injection(self, qtbot, test_sprite_files):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            print(f"✅ ROM injection worker test PASSED - no Qt lifecycle errors")
