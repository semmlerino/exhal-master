...
from PySide6.QtWidgets import QCheckBox, QListWidget, QPushButton, QSlider, QTabWidget
from tests.infrastructure.dialog_test_helpers import DialogTestHelper
from tests.infrastructure.qt_real_testing import EventLoopHelper, QtTestCase
from tests.infrastructure.signal_testing_utils import (
    MultiSignalSpy,
    SignalSpy,
)
from ui.dialogs.manual_offset_unified_integrated import UnifiedManualOffsetDialog as ManualOffsetDialog
