...
# Stub classes for removed components - prevents undefined name errors
class FoundSprite:
    """Stub for removed FoundSprite class."""
    def __init__(self, offset=None, quality=None, timestamp=None, name=None):
        self.offset = offset
...
class FoundSpritesRegistry:
    """Stub for removed FoundSpritesRegistry class."""
    def __init__(self, offset_widget=None, rom_map=None):
        if offset_widget is None:
            raise ValueError("offset_widget is required")
