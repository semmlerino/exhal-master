...
class TestPreviewOrchestrator:
    ...
    def test_request_priority_ordering(self):
        ...
        low_id = self.orchestrator.request_preview("/test/rom.sfc", 0x100000, Priority.LOW)
        normal_id = self.orchestrator.request_preview("/test/rom.sfc", 0x200000, Priority.NORMAL)
        high_id = self.orchestrator.request_preview("/test/rom.sfc", 0x300000, Priority.HIGH)
        urgent_id = self.orchestrator.request_preview("/test/rom.sfc", 0x400000, Priority.URGENT)
    ...
    def test_metrics_tracking(self, qtbot):
        ...
        initial_metrics = self.orchestrator._metrics
