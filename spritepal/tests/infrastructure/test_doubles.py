...
class MockSpriteFinderExternal:
    ...
    def __init__(self, mock_sprites: list[dict[str, Any | None]] = None):
...
class MockCacheManager:
    ...
    def clear_cache(self, rom_path: str = None):
        """Clear cache data."""
        if rom_path:
            cache_key = str(self.get_cache_path(rom_path))
...
class TestDoubleFactory:
    ...
    @staticmethod
    def create_message_box(default_responses: dict[str, int] = None) -> MockMessageBox:
