...
from spritepal.utils.image_utils import pil_to_qpixmap, create_checkerboard_pattern

# Try to import Qt, mark tests as GUI if successful
try:
    from PyQt6.QtGui import QPixmap
    from PyQt6.QtCore import QCoreApplication
    # Try to initialize Qt
...
@pytest.mark.gui
@pytest.mark.skipif(not QT_AVAILABLE, reason="Qt not available or no display")
