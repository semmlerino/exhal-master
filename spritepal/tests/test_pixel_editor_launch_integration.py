...
class TestPixelEditorLaunchIntegration:
    ...
    def test_pixel_editor_launch_success(self, sample_sprite_file, sample_launcher_file):
        ...
        with patch('subprocess.Popen') as mock_popen, \
            ...
            def mock_exists_side_effect(path):
                ...
                if path.endswith("launch_pixel_editor.py"):
                    return True
                return False
    ...
    def test_pixel_editor_launch_invalid_sprite_file(self, sample_launcher_file):
        ...
        with patch('os.path.exists') as mock_exists, \
            ...
            mock_exists.side_effect = mock_exists_side_effect
            mock_validate.return_value = (False, "Invalid file extension: .txt. Allowed: {'.png'}")
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_permission_error(self, sample_sprite_file, sample_launcher_file):
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_subprocess_error(self, sample_sprite_file, sample_launcher_file):
    ...
    @pytest.mark.integration
    def test_pixel_editor_launcher_path_discovery(self, sample_sprite_file, sample_launcher_file):
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_with_palette_files(self, sample_sprite_file, sample_launcher_file):
        ...
        for i in range(8, 16):
            ...
            palette_file.write_text(f'{{"palette": {{"colors": [{{"r": {i*10}, "g": {i*10}, "b": {i*10}}}]}}}}')
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_signal_integration(self, sample_sprite_file, sample_launcher_file):
        ...
        with patch('subprocess.Popen') as mock_popen, \
            ...
            main_window.open_in_editor_requested.emit.assert_called_with(sample_sprite_file)
            
            # Verify connection was made during controller initialization
            main_window.open_in_editor_requested.connect.assert_called_with(controller.open_in_editor)
...
class TestPixelEditorLaunchErrorRecovery:
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_recovery_after_error(self, sample_sprite_file, sample_launcher_file):
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_multiple_attempts(self, sample_sprite_file, sample_launcher_file):
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_cleanup_on_error(self, sample_sprite_file, sample_launcher_file):
...
class TestPixelEditorLaunchPerformance:
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_performance(self, sample_sprite_file, sample_launcher_file):
    ...
    @pytest.mark.integration
    def test_pixel_editor_launch_resource_usage(self, sample_sprite_file, sample_launcher_file):
