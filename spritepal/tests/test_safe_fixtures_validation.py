...
class TestSafeFixtureErrorHandling:
    ...
    def test_qtbot_error_fallback(self):
        ...
        from tests.infrastructure.safe_fixtures import create_safe_qtbot, report_fixture_error
...
class TestSafeFixturePerformance:
    ...
    def test_fixture_creation_speed(self):
        ...
        import time
        from tests.infrastructure.safe_fixtures import create_safe_qtbot, create_safe_qapp
