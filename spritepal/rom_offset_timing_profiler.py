...
class ROMOffsetTimingProfiler:
    ...
    def __init__(self, rom_path: str, target_offset: int):
        ...
        print("ROM Offset Timing Profiler initialized")
    ...
    def _memory_mapped_read(self, offset: int, size: int) -> bytes:
        ...
        with self.rom_path.open("rb") as f, mmap.mmap(f.fileno(), 0, access=mmap.ACCESS_READ) as mm:
    ...
    def _test_memory_cache(self, offset: int, size: int, populate: bool) -> bytes | None:
    ...
    def _test_disk_cache(self, offset: int, size: int, populate: bool) -> bytes | None:
    ...
    def _test_os_page_cache(self, offset: int, size: int, populate: bool) -> bytes | None:
