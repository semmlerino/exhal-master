...
class PerformanceTestRunner:
    ...
    def generate_comprehensive_report(self, results: dict) -> str:
        ...
        if "single_update_ms" in results:
            report += "1. SINGLE PREVIEW UPDATE\n"
            report += f"   Time: {results['single_update_ms']:.2f}ms\n"
            report += "   Target: 16.67ms (60 FPS)\n"
        ...
        if results.get("rapid_movement"):
            metrics = results["rapid_movement"]
            report += "2. RAPID SLIDER MOVEMENT (10 seconds)\n"
        ...
        if "worker_overhead" in results:
            ...
            report += "3. WORKER THREAD OVERHEAD\n"
        ...
        if "signal_latency" in results:
            ...
            report += "4. SIGNAL EMISSION LATENCY\n"
        ...
        if "memory_usage" in results:
            ...
            report += "5. MEMORY USAGE ANALYSIS\n"
        ...
        if "debounce_test" in results:
            report += "6. DEBOUNCE TIMING ANALYSIS\n"
        ...
        if "blocking_operations" in results:
            ...
            report += "7. BLOCKING OPERATIONS ANALYSIS\n"
