...
try:
    ...
    from PySide6.QtWidgets import QApplication, QDialogButtonBox, QLabel, QPushButton, QSplitter, QTabWidget, QWidget
...
class TestImportOnly:
    ...
    def test_framework_dialogs_import(self):
        ...
        try:
            from ui.components import SplitterDialog, TabbedDialog
