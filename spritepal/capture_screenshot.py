    ...
    def take_screenshot():
        ...
        if tab_name:
            if tab_name == "Gallery" and dialog.gallery_tab:
                capture_widget_screenshot(dialog.gallery_tab, f"gallery_tab", "Gallery Tab Widget Only")
            elif tab_name == "Browse" and dialog.browse_tab:
                capture_widget_screenshot(dialog.browse_tab, f"browse_tab", "Browse Tab Widget Only")
            elif tab_name == "Smart" and dialog.smart_tab:
                capture_widget_screenshot(dialog.smart_tab, f"smart_tab", "Smart Tab Widget Only")
            elif tab_name == "History" and dialog.history_tab:
                capture_widget_screenshot(dialog.history_tab, f"history_tab", "History Tab Widget Only")
