...
def describe_gallery_tab():
    ...
    if gallery_tab:
        ...
        if gallery_tab.gallery_widget:
            description.append(f"• Gallery widget present: Yes\n")
            description.append(f"• Gallery widget type: SpriteGalleryWidget\n")
        else:
            description.append(f"• Gallery widget present: No (not initialized)\n")
