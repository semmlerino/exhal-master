...
class GalleryLayoutTestWindow(QMainWindow):
    ...
    def _check_few_sprites_layout(self, sprites: list[dict[str, Any]]):
        ...
        try:
            ...
            first_thumbnail = next(iter(gallery_widget.thumbnails.values())) if gallery_widget.thumbnails else None
            if first_thumbnail:
    ...
    def _check_maximized_layout(self, normal_columns: int):
        ...
        try:
            ...
            if gallery_widget.thumbnails:
                first_thumbnail = next(iter(gallery_widget.thumbnails.values()))
                first_pos_y = first_thumbnail.pos().y()
    ...
    def _update_measurements(self):
        ...
        try:
            ...
            measurements = []
            measurements.append("GALLERY WIDGET MEASUREMENTS")
            ...
            if gallery.thumbnails:
                first_thumb = next(iter(gallery.thumbnails.values()))
