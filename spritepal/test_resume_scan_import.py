...
def test_feature_flag_controls():
    ...
    from ui.components.base import get_dialog_implementation, is_composed_dialogs_enabled, set_dialog_implementation
...
def test_import_with_implementation(use_composed: bool):
    ...
    try:
        ...
        print("  - All class constants present and correct")
