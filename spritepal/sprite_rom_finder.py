...
class SpriteRomFinder:
    ...
    def __init__(self, rom_path: str, exhal_path: str | None = None):
    ...
    def decompress_at(self, offset: int) -> bytes | None:
        ...
        try:
            ...
            result = subprocess.run(cmd, check=False, capture_output=True, timeout=2)
    ...
    def find_sprite(self, ram_data: bytes, quick: bool = True) -> int | None:
        """
    ...
    def process_ram_dump(self, dump_file: str) -> int | None:
    ...
    if len(sys.argv) > 2:
        if sys.argv[2] == "--session":
            ...
            if offset:
                ...
                print("   Use this in SpritePal to edit the sprite")
                print("=" * 40)
            else:
