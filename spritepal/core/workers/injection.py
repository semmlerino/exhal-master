...
from spritepal.core.managers.factory import get_default_factory, StandardManagerFactory
...
class VRAMInjectionWorker(InjectionWorkerBase):
    ...
    def __init__(self, params: VRAMInjectionParams, parent: Optional[QObject] = None) -> None:
...
class ROMInjectionWorker(InjectionWorkerBase):
    ...
    def __init__(self, params: ROMInjectionParams, parent: Optional[QObject] = None) -> None:
        manager = get_injection_manager()
        super().__init__(manager, parent)
        self.params = params  
