...
class ROMPaletteExtractor:
    ...
    def extract_palettes_from_rom(
        ...
        try:
            ...
            for palette_idx in palette_indices:
                ...
                logger.info(f"Extracted palette {palette_idx} to {os.path.basename(palette_path)}")
                
        except Exception as e:
            logger.error(f"Failed to extract palettes from ROM: {e}")
    ...
    def extract_palette_range(
        ...
        try:
            ...
            logger.error(f"Failed to extract palette range: {e}")
