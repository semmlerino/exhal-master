...
from spritepal.utils.constants import (
    COLORS_PER_PALETTE, SPRITE_PALETTE_START, SPRITE_PALETTE_END,
    CGRAM_PALETTE_SIZE, PALETTE_INFO
)
...
class PaletteManager:
    ...
    def __init__(self):
        self.cgram_data = None
        self.palettes = {}
        
    def load_cgram(self, cgram_path):
    ...
    def create_palette_json(self, palette_index, output_path, companion_image=None):
    ...
    def create_metadata_json(self, output_base, palette_files):
        """Create metadata.json for palette switching"""
        metadata = {
            "format_version": "1.0",
    ...
    def analyze_oam_palettes(self, oam_path):
        ...
        return sorted(list(active_palettes))