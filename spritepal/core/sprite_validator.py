...
class SpriteValidator:
    ...
    @staticmethod
    def validate_sprite_comprehensive(sprite_path: str, metadata_path: Optional[str] = None) -> Tuple[bool, List[str], List[str]]:
        """
    ...
    def _validate_dimensions(img: Image.Image) -> Tuple[List[str], List[str]]:
        ...
        if total_tiles > max_tiles:
            warnings.append(f"Sprite sheet has {total_tiles} tiles, which is quite large (max recommended: {max_tiles})")
