...
def test_clipboard_reading():
    ...
    try:
        ...
        if bank > 0xBF:
            ...
            print(f"  This suggests the offset may be from RAM, not ROM")
            print(f"  The Lua script may be capturing RAM->VRAM transfers instead of ROM->VRAM")
            print(f"  HAL decompression will likely fail for this offset")
            print()
        ...
        if offset > 0x400000:  # 4MB max for typical SNES ROM
            ...
            print(f"  This ROM may be larger than usual or the offset may be incorrect")
