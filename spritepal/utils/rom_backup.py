...
class ROMBackupManager:
    ...
    @classmethod
    def create_backup(cls, rom_path: str, backup_dir: Optional[str] = None) -> str:
        """
        ...
        try:
            ...
            raise ROMBackupError(f"Failed to create backup: {e}")
    ...
    def _cleanup_old_backups(cls, backup_dir: str, rom_base: str, rom_ext: str) -> None:
        ...
        try:
            ...
            pattern = f"{rom_base}_backup_*{rom_ext}"
            backups = []
    ...
    @classmethod
    def get_latest_backup(cls, rom_path: str, backup_dir: Optional[str] = None) -> Optional[str]:
        """
    ...
    def restore_backup(cls, backup_path: str, target_path: str) -> None:
        ...
        try:
            ...
            raise ROMBackupError(f"Failed to restore backup: {e}")
    
    @classmethod
    def list_backups(cls, rom_path: str, backup_dir: Optional[str] = None) -> list[dict]:
        """
