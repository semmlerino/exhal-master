...
def test_import(module_name: str, items: List[str] = None) -> Tuple[bool, str]:
    ...
    try:
        ...
        return False, f"✗ Error importing {module_name}: {type(e).__name__}: {str(e)}"
...
def main():
    ...
    try:
        ...
        results["External Dependencies"].append(("PyQt6", False, f"✗ Error importing PyQt6: {str(e)}"))
    ...
    for category, tests in results.items():
        ...
        for module, success, msg in tests:
            print(f"  {msg}")
    ...
    try:
        ...
        from pixel_editor_widgets import TileCanvas, PaletteWidget
