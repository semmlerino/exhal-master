...
class TestApplicationInitialization:
    ...
    def test_viewer_controller_initialization_bug(self, mock_window_class, mock_qapp):
    ...
    @patch("sprite_editor.application.QApplication")
    @patch("sprite_editor.application.MainWindow")
    def test_palette_controller_initialization_bug(self, mock_window_class, mock_qapp):
    ...
    def _create_mock_tab(self):
        ...
        signals = [
            ...
            "browse_oam_requested",
            "inject_requested",
            "browse_source_requested",
            "browse_target_requested",
            "zoom_in_requested",
            "zoom_out_requested",
            "zoom_fit_requested",
            "grid_toggled",
            ...
            "generate_preview_requested",
            "palette_selected",
            "offset_changed",
            "tile_count_changed",
            "multi_palette_toggled",
        ]
