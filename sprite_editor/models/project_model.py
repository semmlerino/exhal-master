...
class ProjectModel(BaseModel):
    ...
    def _load_settings(self):
        ...
        self.remember_window_position = self.settings.get('preferences.remember_window_position', True)
    ...
    def save_settings(self):
        ...
        self.settings.set('preferences.remember_window_position', self.remember_window_position)
