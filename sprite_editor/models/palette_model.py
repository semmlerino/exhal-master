...
from sprite_editor.palette_utils import apply_palette_with_transparency
...
class PaletteModel(BaseModel):
    ...
    def apply_palette_to_image(self, image, palette_index):
        ...
        if palette:
            # Apply palette with proper transparency handling
            modified_palette = apply_palette_with_transparency(palette)
            image.putpalette(modified_palette)
